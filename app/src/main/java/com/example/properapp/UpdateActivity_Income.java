...
public class UpdateActivity_Income extends AppCompatActivity {
    DatabaseHelper myDB;
    EditText date_text;
    EditText time_text;
    // EditText name_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> my_spinner_adapter2 = new ArrayAdapter<String>(UpdateActivity_Income.this,
        ...
        ArrayAdapter<String> my_spinner_adapter = new ArrayAdapter<String>(UpdateActivity_Income.this,
        ...
        contact_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (! hasPermissions(UpdateActivity_Income.this, PERMISSIONS)) {
                    ActivityCompat.requestPermissions(UpdateActivity_Income.this, PERMISSIONS, PERMISSION_ALL);
                }
                sb.setLength(0);
                sb1.setLength(0);
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            // backToast.show();
            startActivity(new Intent(UpdateActivity_Income.this,ListView.class));
    ...
    public void date()
    {
        ...
        date_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(UpdateActivity_Income.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        time_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(UpdateActivity_Income.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timepicker, int hourOfDay, int minute) {
                        time_text.setText(hourOfDay+":"+minute);
                    }
                },hour,minute, DateFormat.is24HourFormat(UpdateActivity_Income.this));
    ...
    public void spinner()
    {
        ...
        ArrayAdapter<String> my_spinner_adapter1 = new ArrayAdapter<String>(UpdateActivity_Income.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Category_Income));
        my_spinner_adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i == 0) {
                    ...
                    Intent update = new Intent(UpdateActivity_Income.this, ListView.class);
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()) {
                        case R.id.Nav_Dashboard:
                            ...
                            startActivity(new Intent(UpdateActivity_Income.this,MainActivity.class));
                            finish();

                            break;
                        case R.id.Nav_List:
                            Intent show1 = new Intent(UpdateActivity_Income.this, ListView.class);
                            startActivity(show1);
                            finish();
                            break;

                        case R.id.Nav_Add:
                            Intent show2 = new Intent(UpdateActivity_Income.this, expense_income_tabbed_activity.class);
                            startActivity(show2);
                            finish();
                            break;
                    }
