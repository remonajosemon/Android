...
public class insert_income_checked extends AppCompatActivity {
    DatabaseHelper myDB;
    EditText date_text;
    EditText time_text;
    // EditText name_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> my_spinner_adapter2 = new ArrayAdapter<String>(insert_income_checked.this,
        ...
        ArrayAdapter<String> my_spinner_adapter = new ArrayAdapter<String>(insert_income_checked.this,
        ...
        category_spinner.setAdapter(my_spinner_adapter);
        ...
        contact_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (! hasPermissions(insert_income_checked.this, PERMISSIONS)) {
                    ActivityCompat.requestPermissions(insert_income_checked.this, PERMISSIONS, PERMISSION_ALL);
                }
                sb.setLength(0);
                sb1.setLength(0);
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            // backToast.show();
            startActivity(new Intent(insert_income_checked.this,ListView_Checked.class));
    ...
    public void date()
    {
        ...
        date_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(insert_income_checked.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        time_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(insert_income_checked.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timepicker, int hourOfDay, int minute) {
                        time_text.setText(hourOfDay+":"+minute);
                    }
                },hour,minute, DateFormat.is24HourFormat(insert_income_checked.this));
    ...
    public void spinner()
    {
        ...
        ArrayAdapter<String> my_spinner_adapter1 = new ArrayAdapter<String>(insert_income_checked.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Category_Income));
        my_spinner_adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        category_spinner.setAdapter(my_spinner_adapter1);
        ...
        insert_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i == 0) {
                    ...
                    {
                        inserted = myDB.insertData(account_spinner.getSelectedItem().toString(), Double.parseDouble(amount_text.getText().toString()), category_spinner.getSelectedItem().toString(), date_text.getText().toString(),time_text.getText().toString(),notes,"income","NORMAL",currencyname,user[0],user[1],name,phone,email);
                    }
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()) {
                        case R.id.Nav_Dashboard:
                            ...
                            startActivity(new Intent(insert_income_checked.this,MainActivity.class));
                            finish();

                            break;
                        case R.id.Nav_List:
                            Intent show1 = new Intent(insert_income_checked.this, ListView.class);
                            startActivity(show1);
                            finish();
                            break;

                        case R.id.Nav_Add:
                            Intent show2 = new Intent(insert_income_checked.this, expense_income_tabbed_activity.class);
                            startActivity(show2);
                            finish();
                            break;
                    }
